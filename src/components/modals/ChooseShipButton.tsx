      ...
      {isLocked ? (
        <div className="flex flex-col sm:flex-row items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-orange-600 via-amber-600 to-orange-500 border border-orange-400/50 rounded-full text-white font-mono text-xs font-black tracking-widest uppercase cursor-pointer hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(249,115,22,0.4)] group"
          >
